  ...
  return (
    ...
    >
      <div className="flex flex-col  justify-around flex-wrap items-center   max-w-[900px]">
        ...
        I am a passionate front-end web developer who finds joy in the perfect blend of logic and creativity. </p>
        <p className="text-gray-300 text-center ">A digital polyglot fluent in HTML, CSS, JavaScript, TypeScript, React and constantly learning. </p>
